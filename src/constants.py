...
main_metadata = {
    ...
    "author": "eri.gg",
    "title": "Eray C.",
    "desc": "Random French student learning some code, messing around with Python and writing stories on Medium.",
